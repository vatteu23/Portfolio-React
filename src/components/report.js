...
import { VictoryChart, VictoryLine, VictoryTooltip,VictoryLabel } from 'victory';
                            ...
                            <div className="col-12 col-md-8" >
                                ...
                                {this.state.visitsData ?
                                    <div ><VictoryChart
                                        ...
                                        <VictoryLabel className="mb-3" text={this.state.visitsTitle} x={105} y={12} style={{paddingTop:'20px'}} textAnchor="middle"/>
                                        <VictoryLine style={{
